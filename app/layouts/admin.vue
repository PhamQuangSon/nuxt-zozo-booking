...
const restaurants = ref([
  { id: "pasta-paradise", name: "Pasta Paradise" },
  { id: "sushi-symphony", name: "Sushi Symphony" },
...
const toggleRestaurant = (restaurantId) => {
  openRestaurants.value[restaurantId] = !openRestaurants.value[restaurantId]
}
