                    ...
                    <div class="flex items-center space-x-3">
                      ...
                      <div v-else class="flex items-center space-x-2">
                        <button 
                          ...
                          class="w-8 h-8 rounded-full border border-orange-500 text-orange-500 flex items-center justify-center hover:bg-orange-50"
                        >
                          <Minus class="h-4 w-4" />
                        </button>
                        <span class="font-semibold min-w-[2rem] text-center">{{ getItemQuantity(item.id) }}</span>
                        <button 
                          @click="increaseQuantity(item.id)"
                          class="w-8 h-8 rounded-full bg-orange-500 text-white flex items-center justify-center hover:bg-orange-600"
                        >
                          <Plus class="h-4 w-4" />
                        </button>
                      </div>
...
const menuItems = ref([
  {
    ...
    description: 'Grilled salmon glazed with our signature teriyaki sauce, served with steamed rice and vegetables',
    price: 24.99,
  ...
  },
  {
    id: 2,
    name: 'Dragon Roll',
    description: 'Tempura shrimp, cucumber, topped with eel, avocado, and eel sauce',
    price: 16.99,
    image: '/placeholder.svg?height=120&width=120',
    category: 'sushi',
    rating: 4.9,
  ...
  },
  {
    id: 3,
    name: 'Chicken Gyoza',
    description: 'Pan-fried dumplings filled with seasoned ground chicken and vegetables',
    price: 8.99,
    image: '/placeholder.svg?height=120&width=120',
    category: 'appetizers',
    rating: 4.7,
  ...
  },
  {
    id: 4,
    name: 'Beef Ramen',
    description: 'Rich tonkotsu broth with tender beef, soft-boiled egg, and fresh vegetables',
    price: 18.99,
    image: '/placeholder.svg?height=120&width=120',
    category: 'noodles',
    rating: 4.6,
  ...
  },
  {
    id: 5,
    name: 'Miso Soup',
    description: 'Traditional soybean paste soup with tofu, seaweed, and green onions',
    price: 4.99,
    image: '/placeholder.svg?height=120&width=120',
    category: 'appetizers',
    rating: 4.5,
  ...
  },
  {
    ...
    description: 'Sweet rice cake filled with premium ice cream, available in multiple flavors',
    price: 6.99,
    image: '/placeholder.svg?height=120&width=120',
    category: 'desserts',
    rating: 4.8,
  ...
  },
  {
    id: 8,
    name: 'Chirashi Bowl',
    description: 'Assorted fresh sashimi over seasoned sushi rice with wasabi and pickled ginger',
    price: 22.99,
    image: '/placeholder.svg?height=120&width=120',
    category: 'sushi',
    rating: 4.9,
