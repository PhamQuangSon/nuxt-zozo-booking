...
const orders = ref([
  ...
  { id: "ORD002", customer: "Bob White", table: 2, total: 30.5, status: "Pending", time: "11:00 AM" },
  { id: "ORD003", customer: "Charlie Green", table: 8, total: 62.75, status: "Completed", time: "10:00 AM" },
])
</script>
